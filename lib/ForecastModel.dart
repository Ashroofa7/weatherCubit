class ForecastModel {
  ...
  Current? _current;
  Forecast? _forecast;
ForecastModel copyWith({  Location? location,
  Current? current,
  Forecast? forecast,
}) => ForecastModel(  location: location ?? _location,
...
class Hour {
  ...
  Hour.fromJson(dynamic json) {
    ...
    _tempF = json['temp_f'];
    _isDay = json['is_day'];
    _conditionh = json['conditionh'] != null ? Conditionh.fromJson(json['conditionh']) : null;
...
Hour copyWith({  num? timeEpoch,
  ...
  tempF: tempF ?? _tempF,
  isDay: isDay ?? _isDay,
  conditionh: conditionh ?? _conditionh,
  ...
  Conditionh? get conditionh => _conditionh;
  ...
  Map<String, dynamic> toJson() {
    ...
    map['is_day'] = _isDay;
    if (_conditionh != null) {
      map['conditionh'] = _conditionh?.toJson();
    }
...
class Conditionh {
  ...
  Conditionh.fromJson(dynamic json) {
    _text = json['text'];
    _icon = json['icon'];
    _code = json['code'];
  }
  ...
  String? _icon;
  num? _code;
Conditionh copyWith({  String? text,
  String? icon,
  num? code,
}) => Conditionh(  text: text ?? _text,
  icon: icon ?? _icon,
  code: code ?? _code,
);
...
class Day {
  ...
  Day.fromJson(dynamic json) {
    ...
    _conditionf = json['conditionf'] != null ? Conditionf.fromJson(json['conditionf']) : null;
    _uv = json['uv'];
  }
  num? _maxtempC;
  num? _maxtempF;
...
Day copyWith({  num? maxtempC,
  ...
  conditionf: conditionf ?? _conditionf,
  uv: uv ?? _uv,
);
  ...
  Conditionf? get conditionf => _conditionf;
  num? get uv => _uv;
  ...
  Map<String, dynamic> toJson() {
    ...
    if (_conditionf != null) {
      map['conditionf'] = _conditionf?.toJson();
    }
    map['uv'] = _uv;
    return map;
  }
...
class Conditionf {
  ...
  Conditionf.fromJson(dynamic json) {
    _text = json['text'];
    _icon = json['icon'];
    _code = json['code'];
  }
  ...
  String? _icon;
  num? _code;
Conditionf copyWith({  String? text,
  String? icon,
  num? code,
}) => Conditionf(  text: text ?? _text,
  icon: icon ?? _icon,
  code: code ?? _code,
);
  String? get text => _text;
...
class Current {
  ...
  Current.fromJson(dynamic json) {
    ...
    _tempF = json['temp_f'];
    _isDay = json['is_day'];
    _condition1 = json['condition1'] != null ? Condition1.fromJson(json['condition1']) : null;
    _windMph = json['wind_mph'];
    _windKph = json['wind_kph'];
    _windDegree = json['wind_degree'];
    _windDir = json['wind_dir'];
...
Current copyWith({  num? lastUpdatedEpoch,
  ...
  tempF: tempF ?? _tempF,
  isDay: isDay ?? _isDay,
  condition1: condition1 ?? _condition1,
  windMph: windMph ?? _windMph,
  windKph: windKph ?? _windKph,
  windDegree: windDegree ?? _windDegree,
  windDir: windDir ?? _windDir,
  ...
  num? get tempF => _tempF;
  num? get isDay => _isDay;
  Condition1? get condition1 => _condition1;
  num? get windMph => _windMph;
  num? get windKph => _windKph;
  num? get windDegree => _windDegree;
  String? get windDir => _windDir;
  ...
  Map<String, dynamic> toJson() {
    ...
    map['is_day'] = _isDay;
    if (_condition1 != null) {
      map['condition1'] = _condition1?.toJson();
    }
    map['wind_mph'] = _windMph;
    map['wind_kph'] = _windKph;
    map['wind_degree'] = _windDegree;
...
class Condition1 {
  ...
  String? _icon;
  num? _code;
Condition1 copyWith({  String? text,
  String? icon,
  num? code,
}) => Condition1(  text: text ?? _text,
  icon: icon ?? _icon,
  code: code ?? _code,
);
  String? get text => _text;
